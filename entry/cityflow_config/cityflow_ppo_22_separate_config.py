...
cityflow_mdppo_default_config = dict(
    exp_name='cityflow_grid22_separate_ppo',
    env=dict(
...
# cityflow_train -e ./smartcross/envs/cityflow_grid/cityflow_grid_22_config.json -d entry/cityflow_config/cityflow_ppo_22_separate_config.py -cn 8
