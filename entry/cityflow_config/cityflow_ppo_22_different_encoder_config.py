...
cityflow_mdppo_default_config = dict(
    exp_name='cityflow_grid22_md_ppo_different_encoder',
    env=dict(
...
# cityflow_train -e ./smartcross/envs/cityflow_grid/cityflow_grid_22_config.json -d entry/cityflow_config/cityflow_ppo_22_different_encoder_config.py -cn 8
